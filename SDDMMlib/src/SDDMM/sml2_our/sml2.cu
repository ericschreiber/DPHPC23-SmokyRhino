    ...
    const int num_iterations) const
{
    ...
    cudaStream_t stream_c_send_a, stream_rp_send_a, stream_ci_send_a, stream_set_zero_a;
    cudaStream_t stream_c_send_b, stream_rp_send_b, stream_ci_send_b, stream_set_zero_b;
